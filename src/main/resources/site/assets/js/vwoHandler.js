var vwo = function () {
    ...
    var templateHelper = function () {
        ...
        var campaignShortcutTemplate = '<div class="vwo-campaign" id="vwo-campaign-${id}">' +
            ...
            newCampaignWizardGoalsSection =
                '<div>' +
                '<label class="centered">Initial Goal</label>' +
                ...
                '<option value="visitPage" checked>Visit Page</option>' +
                '<option value="engagement">Engagement</option>' +
                '<option value="formSubmit">Form Submit</option>' +
                '<option value="clickLink">Click Link</option>' +
            ...
            newCampaignWizardVariationsSection =
                '<div>' +
                '<label class="centered">Initial Variations</label>' +
            ...
            newCampaignWizardSectionsSection =
                '<div>' +
                '<label class="centered">Initial section</label>' +
    ...
    var vwoNewCampaignWizardManager = function () {
        ...
        var validateForm = function (form) {
            $(form).find(".create-new-campaign-in-vwo-btn").removeAttr("disabled");
        }
        ...
        return {
            collectWizardDataAndSendNewCampaignRequest: function () {
                ...
                var callback = function (result) {
                    ...
                    if (api.notify.NotifyManager) {
                        api.notify.NotifyManager.get().showSuccess("Successfully created " + selectedCampaignType + " campaign.");
                    }
